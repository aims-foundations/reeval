...
if __name__ == "__main__":
    ...
    for url in tqdm(hrefs):
        ...
        for row in rows:
            true_tag = 0
            try:
                td_element = row.find_element(
                    By.CSS_SELECTOR, "td.z-0.bg-gray-50, td.z-0.bg-white"
                )
                # Find the <a> tag inside the located <td> element
                model_element = td_element.find_element(
                    By.CSS_SELECTOR, "a.link.link-hover"
                )
                ...
                try:
                    ...
                    model_element = row.find_element(
                        By.CSS_SELECTOR,
                        "div.underline.decoration-dashed.decoration-gray-300.z-10",
                    )
            ...
            try:
                ...
                score_element = td_element.find_element(
                    By.CSS_SELECTOR, "div.flex.items-center"
                )
