...
def compute_metrics_single_ds(
    ...
    if not os.path.exists(f"{generated_questions_folder}/sft/{args.dataset}{model_short_name}/{model_name}.csv"):
        return
    
    # if os.path.exists(f"../data/sft_analysis/{args.dataset}/{model_name}_with_y.csv"):
    #     return
    
    answer_df = pd.read_csv(f"{generated_questions_folder}/sft/{args.dataset}{model_short_name}/{model_name}.csv")
    ...
    answer_df.to_csv(f"../data/sft_analysis/{args.dataset}{model_short_name}/{model_name}_with_y.csv", index=False)
