...
import torch
from utils import item_response_fn_2PL_jnp, set_seed, item_response_fn_2PL, theta_corr_ctt_plot
...
if __name__ == "__main__":
    # wandb.init(project="em_2pl_calibration_norm")
    ...
    output_dir = f'../data/em_2pl_calibration_norm/{args.dataset}'
    plot_dir = f'../plot/em_2pl_calibration_norm'
    ...
    z2_samples = z2_samples / np.mean(z2_samples, axis=1, keepdims=True)
