...
def goodness_of_fit_1PL_plot(
    ...
    mean_diff, diff_array = goodness_of_fit_1PL(
        theta, z3_samples, y, bin_size
    )
    sample_means = []
    for _ in range(100):
...
if __name__ == "__main__":
    ...
    output_dir = f'../data/mcmc_1pl_calibration/{args.dataset}'
    plot_dir = f'../plot/mcmc_1pl_calibration'
