...
from utils import get_embed, plot_rewards
...
if __name__ == "__main__":
    ...
    test_dataset = load_dataset("stair-lab/airbench-ppo", split="train")
    ...
    for step in range(0, 500, 50):
        ...
        print(f"Predicted z: {pred_zs}")
        
        reward = [-abs(a - b) for a, b in zip(pred_zs, gt_zs)]
        rewards.append(reward)
        
    plot_rewards(rewards, f"{plot_dir}/ppo_reward.png")
