...
if __name__ == "__main__":
    # wandb.init(project="mle_2pl_calibration_prior")
    ...
    output_dir = f'../data/mle_2pl_calibration_prior/{args.dataset}'
    plot_dir = f'../plot/mle_2pl_calibration_prior/{args.dataset}'
